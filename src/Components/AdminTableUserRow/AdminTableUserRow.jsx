...
export function AdminTableUserRow({ data }) {
    ...
    const [participant_team_id , setParticipant_team_id] = useState(data.participant_team_id || "No Team");
            ...
            {visible && (
                <div className={`info ${visible ? "info-visible" : "info-invisible"}`}>
                    ...
                    <div className="two-info-row">
                        <div className="info-row">
                            <h3>Team:</h3>
                            <input type="text" value={participant_team_id} onChange={(e)=>{setParticipant_team_id(e.target.value)}}/>
                        </div>
                        <div className="info-row">
                            <button>
